...
if ( ! class_exists( 'sirrine_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 */
	class sirrine_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'sirrine_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'sirrine_get_localized_font_family_elements',
				array(
			...
			return sirrine_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
